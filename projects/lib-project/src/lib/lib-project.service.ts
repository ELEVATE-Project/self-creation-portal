    ...
    if (this.formMeta.formValidation.projectDetails === 'VALID' &&
      ...
      if(this.projectData.certificate && this.projectData.certificate.criteria.conditions.C4) {
        ...
        if(Object.keys(this.projectData.certificate.criteria.conditions.C4.conditions)[0]) {
          ...
          if(this.projectData.certificate.criteria.conditions.C3) {
        ...
        this.projectData.certificate.criteria.conditions.C4.validationText = "Add " + value + " evidence" + (parseInt(value) > 1 ? "s":'') + " at any task level"
      }
